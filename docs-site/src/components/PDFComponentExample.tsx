...
export default function PDFComponentExample() {
  ...
  useEffect(() => {
    ...
    import('react-to-pdf').then((module) => {
      ...
      console.error('[PDFComponentExample] Failed to load react-to-pdf:', error);
    });
  }, []);
          ...
          <div>
            ...
            >
              ...
              <p style={{
                ...
                The PDF component provides a declarative API for generating PDFs. Instead of using
                hooks, you can wrap your content with the PDF component and access the generation
                functionality through a render prop.
              </p>
              ...
              <ul style={{
                ...
                <li>
                  <strong>Declarative API:</strong> More intuitive for React developers
                </li>
                <li>
                  <strong>Render Props Pattern:</strong> Flexible and composable
                </li>
                <li>
                  <strong>Same Options:</strong> All usePDF options are available
                </li>
                <li>
                  <strong>Better Encapsulation:</strong> PDF logic stays with the component
                </li>
              </ul>
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  <strong>💡 Tip:</strong> The PDF component is perfect for creating reusable
                  PDF templates. You can extract common configurations into a wrapper component
