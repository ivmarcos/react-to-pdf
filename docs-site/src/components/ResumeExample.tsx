...
function ResumeContent({ usePDF }: { usePDF: any }) {
  ...
  const resumeData = {
    ...
    summary:
      "Experienced full stack developer with 8+ years building scalable web applications. Passionate about creating elegant solutions to complex problems and mentoring junior developers.",
    experience: [
      {
